...
// connect to db
mongoose.connect('mongodb+srv://' + process.env.DB_USER + ':' + process.env.DB_PASS + '@' + process.env.DB_HOST + ':/ngodb?authSource=admin', {
//mongoose.connect('mongodb+srv://admin:admin@cluster0.hzxcl.mongodb.net/ngodb?retryWrites=true&w=majority', {
	useNewUrlParser: true
}).then(
	() => console.log(chalk.yellow('Connected to mongo database at localhost')),
